<ul class="list-group">
  ...
  <a href="{{ route('security_social.index') }}" class="list-group-item list-group-item-action">Security & Social map</a>
  <a href="{{ route('security_social.create') }}" class="list-group-item list-group-item-action">Security & Social Areas</a>
