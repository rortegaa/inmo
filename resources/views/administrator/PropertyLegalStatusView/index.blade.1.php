                   ...
                   <tr>
                       ...
                       <td class="text-center">
                           <div class="d-flex justify-content-center bd-highlight">                                
                                    <button id="{{ $status->property_legal_status }}" class="btn btn-outline-primary btn-sm" v-on:click="updateAlert"><i class="fas fa-pen"></i></button>                       
                                <form id="delete {{ $status->property_legal_status }}" method="POST" action=" {{ route('legal_status.destroy',['status'=>$status->property_legal_status]) }}">
                                    @method('DELETE')
                                    @csrf
                                <button class="btn btn-outline-danger btn-sm" v-on:click="onDeleteRecord"><i class="fas fa-trash-alt"></i></button>
                                </form>
                           </div>
                       </td>
                   </tr>
