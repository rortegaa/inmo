    ...
    <form method="POST" action="{{ route('property.update' ,['id'=>$property->id]) }})" role="form" enctype="multipart/form-data">
        ...
        <div class="row my-2">
            ...
            <div class="col-3 form-group">
                ...
                <input name="total_lot_area" type="number" class="form-control" id="total_lot_area" min="0" step=0.01 value="{{$property->propertyInformation->total_lot_area}}">
            </div>
        </div>
        <div class="row my-2">
            <div class="col-12 form-group">
                <label for="message_sale">Sale Message:</label>
                <textarea class="form-control" rows="4" cols="50" name="message_sale" id="message_sale">{{$property->propertyInformation->message_sale}}</textarea>
            </div>
        </div>
